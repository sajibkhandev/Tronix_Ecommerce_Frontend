...
const Product1 = ({price,heading}) => {
  return (
    <div>
        <div className='w-[512px] h-[290px] flex rounded-r-[36px] border-solid border border-primary mb-12'>
            <div className='w-[240px] bg-primary'>
                <div className='w-[64px] h-[64px] rounded-full flex justify-center items-center bg-third text-white text-lg font-pop font-normal m-6'>NEW</div>
                </div>
